 ...
 * @version: 
 * @Author: sueRimn
 * @Date: 2022-12-23 17:21:56
 * @LastEditors: sueRimn
 * @LastEditTime: 2022-12-23 17:56:51
 */
...
const server = http.createServer(function (req, res) {
  ...
  res.setHeader('Access-Control-Allow-Headers', 'x-requested-with,Authorization,token, content-type,name ,age');
