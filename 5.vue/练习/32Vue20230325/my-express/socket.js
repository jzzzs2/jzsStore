 ...
 * @LastEditors: sueRimn
 * @LastEditTime: 2023-03-29 18:35:49
 */
...
io.on("connection", socket => {
  ...
  socket.on("login", ({ nickname }) => {
    ...
    socket.broadcast.emit("enter", { type: "action", msg: `${nickname}进入了聊天室~` })
  })
  socket.on("disconnect", () => {
    delete socketObjMap[socket.nickname]
    console.log("登出");
    io.sockets.emit("leave", { type: "action", msg: `${socket.nickname}离开了聊天室~` })
  })
