        ...
        <div class="account-box">
          <div class="form">
            <el-form label-position="right" label-width="60px"
              status-icon :model="loginParams"  :rules="rules" ref="formEle">
              <el-form-item  label="账户" prop="account">
                <el-input v-model="loginParams.account" />
              </el-form-item>
              <el-form-item label="密码" prop="password">
                <el-input v-model="loginParams.password" />
              </el-form-item>
              <el-form-item label-width="22px" prop="agree">
                <el-checkbox  size="large" v-model="loginParams.agree">
                  我已同意隐私条款和服务条款
                </el-checkbox>
              </el-form-item>
              <el-button size="large" class="subBtn" @click="loginHandle">点击登录</el-button>
            </el-form>
          </div>
        </div>
      </div>
